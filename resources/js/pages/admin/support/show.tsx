...
export default function AdminSupportShow({ ticket, messages }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={[
            ...
            { title: ticket.ticket_unique_id, href: `/admin/support-tickets/${ticket.id}` }
        ]}>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground mt-1">
                                    Opened by {ticket.user_name} on {ticket.created_at}
                                </p>
                            </div>
