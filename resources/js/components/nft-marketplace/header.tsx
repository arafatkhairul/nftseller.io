        ...
        <header className="bg-background/80 backdrop-blur-md border-b border-border text-foreground sticky top-0 z-50 pro-header">
            ...
            <div className="flex items-center justify-between px-4 py-3 lg:px-8">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xl font-bold text-foreground text-glow">NFTSELLER.IO</span>
                </div>
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-8 py-4 lg:py-0">
                        {navigationItems.map((item) => (
                            <a
                                key={item.label}
                                href={item.href}
                                className={`py-2 lg:py-4 px-2 text-sm font-medium transition-colors hover:text-primary ${
                                    item.active
