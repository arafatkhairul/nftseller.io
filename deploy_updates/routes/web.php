...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::get('dashboard', function () {
        ...
        $completedOrdersTotal = $user->orders()
        ...
        $orderStats = [
            ...
            'approvedOrder' => $user->orders()->where('status', 'completed')->count(),
            'sentOrder' => $user->orders()->where('status', 'sent')->count(),
        ];
    ...
    // NFT Likes
    Route::post('nfts/{nft}/like', [\App\Http\Controllers\NftController::class, 'toggleLike'])->name('nfts.like');
});
