...
export default function Dashboard({ orders = [], completedOrdersTotal = 0, orderStats }: Props) {
    ...
    const stats = {
        ...
        pendingOrder: orderStats?.pendingOrder ?? 0,
        approvedOrder: orderStats?.approvedOrder ?? 0,
        sentOrder: orderStats?.sentOrder ?? 0,
    };
